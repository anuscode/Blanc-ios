...
class RegistrationBloodTypeViewController: UIViewController {
    ...
    lazy private var collectionView: UICollectionView = {
        ...
        Observable
            ...
            .bind(to: collectionView.rx.items(
                ...
                let isSelectedRow = (row == self.user?.bloodId)
                let text = item
        ...
        Observable
            ...
            .bind { (indexPath, model) in
                self.user?.bloodId = indexPath.row
                self.collectionView.reloadItems(at: [indexPath])
            }
            .disposed(by: disposeBag)
    ...
    private func next() {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "RegistrationIntroductionViewController")
