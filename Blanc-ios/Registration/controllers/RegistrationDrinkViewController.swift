...
class RegistrationDrinkViewController: UIViewController {
    ...
    private func update() {
        ...
        let indexPath = IndexPath(row: user!.drinkId!, section: 0)
    ...
    private func presentNextView() {
        ...
        navigation.present(identifier: "RegistrationSmokingViewController")
    }

    private func presentBackView() {
        let navigation = navigationController as! RegistrationNavigationViewController
        navigation.present(identifier: "RegistrationReligionViewController", animated: false)
    }
}


extension RegistrationDrinkViewController: UITableViewDelegate, UITableViewDataSource {
