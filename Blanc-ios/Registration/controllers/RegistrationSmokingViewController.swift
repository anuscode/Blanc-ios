...
class RegistrationSmokingViewController: UIViewController {
    ...
    private func update() {
        ...
        let indexPath = IndexPath(row: user!.smokingId!, section: 0)
...
extension RegistrationSmokingViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == user?.smokingId {
            cell.select()
        }
        return cell
    }
