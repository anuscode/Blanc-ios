...
class PostService {
    ...
    func listPosts(lastId: String?) -> Single<[PostDTO]> {
        provider.rx.request(.listPosts(lastId: lastId))
                .debug()
    ...
    func getPost(postId: String?) -> Single<PostDTO> {
        provider.rx.request(.getPost(postId: postId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .map(PostDTO.self, using: decoder)
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
    ...
    func listAllFavoriteUsers(uid: String?, postId: String?) -> Single<[UserDTO]> {
        provider.rx.request(.listAllFavoriteUsers(uid: uid, postId: postId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
    ...
    func createPost(uid: String?, files: [UIImage], description: String?, enableComment: Bool) -> Single<Void> {
        provider.rx.request(.createPost(uid: uid, files: files, description: description, enableComment: enableComment))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func createFavorite(uid: String?, postId: String?) -> Single<Void> {
        provider.rx.request(.createFavorite(uid: uid, postId: postId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func createComment(uid: String?, postId: String?, commentId: String?, comment: String) -> Single<CommentDTO> {
        provider.rx.request(.createComment(uid: uid, postId: postId, commentId: commentId, comment: comment))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
    ...
    func createThumbUp(uid: String?, postId: String?, commentId: String?) -> Single<Void> {
        provider.rx.request(.createThumbUp(uid: uid, postId: postId, commentId: commentId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func createThumbDown(uid: String?, postId: String?, commentId: String?) -> Single<Void> {
        provider.rx.request(.createThumbDown(uid: uid, postId: postId, commentId: commentId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func deletePost(uid: String?, postId: String?) -> Single<PostDTO> {
        provider.rx.request(.deletePost(uid: uid, postId: postId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .map(PostDTO.self, using: decoder)
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
    ...
    func deleteFavorite(uid: String?, postId: String?) -> Single<Void> {
        provider.rx.request(.deleteFavorite(uid: uid, postId: postId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func deleteComment(uid: String?, postId: String?, commentId: String?) -> Single<Void> {
        provider.rx.request(.deleteComment(uid: uid, postId: postId, commentId: commentId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func deleteThumbUp(uid: String?, postId: String?, commentId: String?) -> Single<Void> {
        provider.rx.request(.deleteThumbUp(uid: uid, postId: postId, commentId: commentId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
    ...
    func deleteThumbDown(uid: String?, postId: String?, commentId: String?) -> Single<Void> {
        provider.rx.request(.deleteThumbDown(uid: uid, postId: postId, commentId: commentId))
                .debug()
                .filterSuccessfulStatusAndRedirectCodes()
                .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
                .map { _ in
