...
class UserService {
    ...
    func listRecommendedUsers(uid: String?, userId: String?) -> Single<[UserDTO]> {
        provider.rx
            .request(.listRecommendedUsers(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func listCloseUsers(uid: String?, userId: String?) -> Single<[UserDTO]> {
        provider.rx
            .request(.listCloseUsers(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func listRealTimeAccessUsers(uid: String?, userId: String?) -> Single<[UserDTO]> {
        provider.rx
            .request(.listRealTimeAccessUsers(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func listAllUserPosts(uid: String?, userId: String?) -> Single<[PostDTO]> {
        provider.rx
            .request(.listAllUserPosts(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func listUsersRatedMeHigh(uid: String?, userId: String?) -> Single<[UserDTO]> {
        provider.rx
            .request(.listUsersRatedMeHigh(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func listUsersIRatedHigh(uid: String?, userId: String?) -> Single<[UserDTO]> {
        provider.rx
            .request(.listUsersIRatedHigh(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func listUsersRatedMe(uid: String?, userId: String?) -> Single<[RaterDTO]> {
        provider.rx
            .request(.listUsersRatedMe(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func getPushSetting(uid: String?, userId: String?) -> Single<PushSetting> {
        provider.rx
            .request(.getPushSetting(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func pushPoke(uid: String?, userId: String?) -> Single<Void> {
        provider.rx
            .request(.pushPoke(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func pushLookUp(uid: String?, userId: String?) -> Single<Void> {
        provider.rx
            .request(.pushLookUp(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func uploadUserImage(uid: String?, userId: String?, index: Int?, file: UIImage) -> Single<ImageDTO> {
        provider.rx
            .request(.uploadUserImage(uid: uid, userId: userId, index: index, file: file))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func updateDeviceToken(uid: String?, deviceToken: String?) -> Single<UserDTO> {
        provider.rx
            .request(.updateDeviceToken(uid: uid, deviceToken: deviceToken))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func updateUserStatusPending(uid: String?, userId: String?) -> Single<UserDTO> {
        provider.rx
            .request(.updateUserStatusPending(uid: uid, userId: userId))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func updateUserStarRatingScore(uid: String?, userId: String?, score: Int) -> Single<UserDTO> {
        provider.rx
            .request(.updateUserStarRatingScore(uid: uid, userId: userId, score: score))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .filterSuccessfulStatusAndRedirectCodes()
    ...
    func updateUserLastLoginAt(uid: String?, userId: String?) -> Single<Void> {
        provider.rx
            .request(.updateUserLastLoginAt(uid: uid, userId: userId))
            .debug()
            .filterSuccessfulStatusAndRedirectCodes()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
    ...
    func updateUserPushSetting(uid: String?, userId: String?, pushSetting: PushSetting) -> Single<Void> {
        provider.rx
            .request(.updateUserPushSetting(uid: uid, userId: userId, pushSetting: pushSetting))
            .debug()
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .map({ _ in Void() })
    ...
    func deleteUserImage(uid: String?, userId: String?, index: Int) -> Single<UserDTO> {
        provider.rx
            .request(.deleteUserImage(uid: uid, userId: userId, index: index))
            .subscribeOn(SerialDispatchQueueScheduler(qos: .default))
            .observeOn(SerialDispatchQueueScheduler(qos: .default))
            .debug()
            .filterSuccessfulStatusAndRedirectCodes()
