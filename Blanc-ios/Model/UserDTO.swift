...
struct UserGlobal: Codable {
    ...
    static let idealTypes: [String] = [
        "운동을 좋아하는", "허세가 없는", "예의가 바른", "연락 자주 하는", "티키타카가 되는",
        "자주 표현하는", "솔직한", "피부가 좋은", "바람 안피는", "자기 일에 열정적인",
        "귀여운", "유머감각 있는", "섹시한", "배려심 깊은", "착한", "자주 만날 수 있는",
        "미소가 예쁜", "털털한", "개방적인", "말이 많은", "바른",
        "다정한", "잘 노는", "패션감각이 좋은", "애교 많은", "착하게 말하는",
        "편식 않하는", "목소리가좋은"
    ]

    static let interests: [String] = [
        "자전거", "드라이브", "커피", "웹툰", "전시회", "드라마", "그림", "여행", "패션", "쇼핑",
        "독서", "사진", "문학", "정치", "반려동물", "영화보기", "글쓰기", "외국어/어학", "맛집탐방", "IT",
        "미용", "술", "댄스", "애니", "자기계발", "스포츠/운동", "악기연주", "피트니스", "레져",
        "봉사활동", "인테리어", "재테크", "게임", "공연 관람", "요리", "음악", "덕질", "산책", "노래"
    ]
}
