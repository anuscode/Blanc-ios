...
class OccupationViewController: UIViewController {
    ...
    @objc private func didTapConfirmButton() {
        ...
        user?.occupation = selected?.value
        profileViewModel?.update()
    }

    private func update() {
        let value = user?.occupation
...
extension OccupationViewController: UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
