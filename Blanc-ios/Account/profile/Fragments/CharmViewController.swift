...
class CharmViewController: UIViewController {
    ...
    @objc private func didTapConfirmButton() {
        userDTO?.charmIds = selectedValues
...
extension CharmViewController: TTGTextTagCollectionViewDelegate {
